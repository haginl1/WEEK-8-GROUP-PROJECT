...
// function setHTML() {
    ...
    // row.append($('<td><button type="button" class="btn btn-xs btn-warning fav" fav="' + fav + '" id="' + beer.beerID + '">★</button></td>'))
    //     .append($('<td><a href="#' + beer.beerID + 'info" data-parent="#accordion" data-toggle="collapse">' + beer.name + '</td>'))
    //     .append($('<td>' + beer.style + '</td>'))
    //     .append($('<td><div class="btn-group"><button type="button" class="btn btn-xs btn-default selection" >' + rating + '</button><button type="button" class="btn btn-xs btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button><ul class="dropdown-menu"><li><a href="#">1</a></li><li><a href="#">2</a></li><li><a href="#">3</a></li><li><a href="#">4</a></li><li><a href="#">5</a></li><li><a href="#">6</a></li><li><a href="#">7</a></li><li><a href="#">8</a></li><li><a href="#">9</a></li><li><a href="#">10</a></li></ul></div></td>'))
    //     .append($('<td>' + beer.abv + '</td>'))
    //     .append($('<td><button type="button" class="btn btn-danger btn-xs delete" id="' + beer.beerID + '">X</button></td>'))
    // beerNames.push(name) 
    // rows.push(row);
    // var info = $('<tr id="' + beer.beerID + 'info" class="panel-collapse collapse">');
    // info.append($('<td colspan=6><div class="row"><div class="col-xs-4"><img src="' + beer.labels + '"></div><div class="col-xs-8"><p>' + beer.description + '<br><br>' + beer.styleDescription + '</p><textarea class="form-control" id="' + beer.beerID + 'note">' + beer.note + '</textarea></div></div></td>'))

    // rows.push(info);
    // }
    // $("tbody").html(rows); //added for sorting
// }
...
//  var sortedBeer, sortedABV, sortedStyle; 
